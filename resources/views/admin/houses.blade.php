            ...
            <section class="houses-page">
                ...
                <div class="houses-toolbar">
                    <div class="toolbar-left">
                        <span
                            class="chip {{ strtolower($houses[0]['status']) === 'inactive' ? 'chip-gray' : 'chip-green' }}"
                            id="houseStatus"
                        >
                            {{ $houses[0]['status'] }}
                        </span>
                        ...
                        <div class="gauge-group">
                            <div class="gauge-item">
                                <div class="semi-gauge">
                                    <div class="semi-gauge-inner" id="houseTemperature">
                                        {{ $houses[0]['pens'][0]['temperature'] }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="gauge-item">
                                <div class="semi-gauge">
                                    <div class="semi-gauge-inner" id="houseAmmonia">
                                        {{ $houses[0]['pens'][0]['ammonia'] }}
                                    </div>
                                </div>
                            </div>
                        </div>
