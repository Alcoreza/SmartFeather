...
@section('title', 'Farm Management Records')
...
@section('content')
    <div class="manager-shell">
        ...
        <main class="manager-main record-house-main">
            <section class="record-house-page">
                ...
                <div class="record-house-controls">
                    <a href="{{ route('manager.houses') }}" class="record-back-btn" aria-label="Back to Farm Management">
                        &#10094;
                    </a>
